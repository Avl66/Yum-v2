  ...
  return (
    <>
      <div className="container-fluid footerNav bg-dark">
        <footer
          id="footerBar"
          className="d-flex flex-wrap align-items-center justify-content-center py-2"
        >
          <p className="mb-0 text-light">
            &copy; 2023/ Version 2.0 by Uma Avula
          </p>

          <div
            id="linkBar"
            className="nav flex-fill align-items-center justify-content-end link-light text-decoration-none"
          >
            <Link
              to="#"
